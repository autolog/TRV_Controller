...
# -*- coding: utf-8 -*-
#
# TRV Controller - Constants © Autolog 2018-2022
#
import logging
...
TESTING_UPDATE_TRANSLATION = dict()
...
def constant_id(constant_label) -> int:  # Auto increment constant id
    global number
    global TESTING_UPDATE_TRANSLATION
    if debug_show_constants and number == -1:
        indigo.server.log("TRV Controller Plugin internal Constant Name mapping ...", level=logging.DEBUG)
    number += 1
    TESTING_UPDATE_TRANSLATION[number] = constant_label
...
TESTING_UPDATE_CONTROLLER_MODE = constant_id("TESTING_UPDATE_CONTROLLER_MODE")

TESTING_UPDATE_TRANSLATION[TESTING_UPDATE_CONTROLLER_MODE] = 'UPDATE CONTROLLER MODE'
...
DEVICE_TYPE_TRANSLATION[RADIATOR] = 'RADIATOR'
...
UPDATE_CONTROLLER_MODE = 0  # noqa [Duplicated code fragment!]
...
UPDATE_RADIATOR_BATTERY_LEVEL = 14
UPDATE_RADIATOR_TEMPERATURE = 15

UPDATE_ZWAVE_WAKEUP_INTERVAL = 16
UPDATE_ZWAVE_HVAC_OPERATION_MODE_ID = 17
UPDATE_ZWAVE_EVENT_RECEIVED_TRV = 18
UPDATE_ZWAVE_EVENT_RECEIVED_REMOTE = 19
UPDATE_ZWAVE_EVENT_SENT_TRV = 20
UPDATE_ZWAVE_EVENT_SENT_REMOTE = 21

UPDATE_EVENT_RECEIVED_REMOTE = 22
UPDATE_EVENT_RECEIVED_RADIATOR = 23
...
UPDATE_TRANSLATION[UPDATE_RADIATOR_BATTERY_LEVEL] = 'UPDATE RADIATOR BATTERY LEVEL'
UPDATE_TRANSLATION[UPDATE_RADIATOR_TEMPERATURE] = 'UPDATE RADIATOR TEMPERATURE'
...
UPDATE_TRANSLATION[UPDATE_EVENT_RECEIVED_RADIATOR] = 'UPDATE EVENT RECEIVED RADIATOR'
...
ZWAVE_COMMAND_VERB_TRANSLATION[ZWAVE_COMMAND_VERB_03] = 'Get Scale'
...
# ADVANCED OPTIONS
ADVANCED_OPTION_NOT_SET = 0
ADVANCED_OPTION_NONE = 1
ADVANCED_OPTION_FIRMWARE_WORKAROUND = 2
ADVANCED_OPTION_VALVE_ASSISTANCE = 3

# ADVANCED OPTIONS [translation]
ADVANCED_OPTION_UI = dict()
ADVANCED_OPTION_UI[ADVANCED_OPTION_NOT_SET] = 'No Advanced Option selected'
ADVANCED_OPTION_UI[ADVANCED_OPTION_NONE] = 'No Advanced Option in operation'
ADVANCED_OPTION_UI[ADVANCED_OPTION_FIRMWARE_WORKAROUND] = 'Firmware Workaround in operation'
ADVANCED_OPTION_UI[ADVANCED_OPTION_VALVE_ASSISTANCE] = 'Valve Assistance in operation'
...
CMD_STOP_THREAD = 0  # noqa [Duplicated code fragment!]
...
CMD_ACTION_POLL = 21
CMD_TRIGGER_POLL = 22
CMD_INVOKE_DATAGRAPH_USING_POSTGRESQL_TO_CSV = 23
CMD_UPDATE_RADIATOR_STATES = 24
...
CMD_TRANSLATION[CMD_ACTION_POLL] = 'ACTION POLL'
CMD_TRANSLATION[CMD_TRIGGER_POLL] = 'TRIGGER POLL'
CMD_TRANSLATION[CMD_INVOKE_DATAGRAPH_USING_POSTGRESQL_TO_CSV] = 'UPDATE DATAGRAPH CSV FILE VIA POSTGRESQL'
CMD_TRANSLATION[CMD_UPDATE_RADIATOR_STATES] = 'UPDATE RADIATOR STATES'
